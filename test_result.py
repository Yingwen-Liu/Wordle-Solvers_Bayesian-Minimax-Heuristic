...
solvers_data = {
    ...
    "BayesianSolver PositionHandler": {
        "x": (1, 2, 3, 4, 5, 6),
        "y": (1, 73, 955, 1104, 172, 4)
    },
    "MinimaxSolver Handler All": {
        "x": (1, 2, 3, 4, 5, 6),
    ...
    "MinimaxSolver PositionHandler": {
        "x": (1, 2, 3, 4, 5, 6),
        "y": (1, 60, 849, 1190, 202, 7)
    },
    "HeuristicSolver Handler All": {
        "x": (1, 2, 3, 4, 5, 6, 7),
    ...
    "HeuristicSolver PositionHandler": {
        "x": (1, 2, 3, 4, 5, 6),
        "y": (1, 71, 880, 1228, 124, 5)
    },
    "FixedSolver Handler": {
        "x": (1, 2, 3, 4, 5, 6, 7, 8, 9),
